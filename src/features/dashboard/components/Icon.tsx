...
const ICONS: Record<string, ReactNode> = {
  ...
  savings: (
    <path d="M12 3l8 4v5c0 5-3.5 8.5-8 10-4.5-1.5-8-5-8-10V7l8-4zM9 12l2 2 4-4" />
  ),
...
export default function Icon({ name, size = 18, className = "", strokeWidth = 1.8, ...rest }: IconProps) {
