...
export const MOCK_INSIGHTS = [
  {
    ...
    icon: "↓",
    tone: "positive",
    title: "You spent 12% less this month.",
    body: "Great discipline — your outflow dropped across Food & Dining and Entertainment.",
  },
  {
    id: "i2",
    icon: "◉",
    tone: "info",
    title: "Food & Dining is your second-largest category.",
    body: "Currently 23% of total spending. Try meal planning to reduce by 10%.",
  },
  {
    id: "i3",
    icon: "✓",
    tone: "positive",
    title: "You saved 28% of your income this month.",
    body: "Above the recommended 20% savings rate. Keep going.",
  },
  {
    id: "i4",
    icon: "◔",
    tone: "warning",
    title: "$180 left in your entertainment budget.",
    body: "You are 70% through this category for the month.",
  },
  {
    id: "i5",
    icon: "↑",
    tone: "info",
    title: "Expenses decreased vs last month.",
    body: "Outflow is down 4.1% compared with September.",
  },
  {
    id: "i6",
    icon: "◆",
    tone: "positive",
    title: "Your savings increased by $620 this month.",
    body: "Driven by higher income and reduced discretionary spending.",
  },
];
...
const baseMonthlyExpenses = [
  3800, 3920, 4050, 4100, 4200, 4400, 4080, 4180, 4150, 4250, 4280, 4100,
];
